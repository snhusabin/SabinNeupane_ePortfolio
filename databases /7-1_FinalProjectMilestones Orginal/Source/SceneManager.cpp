...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 0.0f, 1.2f, 2.0f);  // In front of the scene
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.3f, 0.3f, 0.3f);  // Neutral, soft white light
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.0f, 0.0f, 0.0f);
	m_pShaderManager->setFloatValue("lightSources[1].focalStrength", 90.0f);  // Covers more area
	m_pShaderManager->setFloatValue("lightSources[1].specularIntensity", 0.05f); // Low intensity
